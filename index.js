(function ($) {
    var obj = {
        ...
        getSearchData: function () {
            ...
            var size = this.size;
            $.ajax({
                url: 'http://api.duyiedu.com/api/student/searchStudent?appkey=youyanbin_1553944415563',
        ...
        newAddStudent: function (data) {
            $.ajax({
                url: 'http://api.duyiedu.com/api/student/addStudent?appkey=youyanbin_1553944415563',
                data: data,
                success: function () {
                    alert('新增成功');
        ...
        getAllData: function () {
            var self = this;
            $.ajax({
                url: 'http://api.duyiedu.com/api/student/findAll?appkey=youyanbin_1553944415563',
                beforeSend: function () {
        ...
        pop: function () {
            ...
            $('.edit').on('click', function () {
                ...
                $('.submit').on('click', function () {
                    ...
                    // 发送修改后的数据到后端 
                    $.ajax({
                        url: 'http://api.duyiedu.com/api/student/updateStudent?appkey=youyanbin_1553944415563',
                        data: data,
                        success: function (data) {
                            $('.modal').hide();
                            alert('修改成功~');
            ...
            $('.del').on('click', function () {
                ...
                $('.sure-btn').on('click', function () {
                    $.ajax({
                        url: 'http://api.duyiedu.com/api/student/delBySno?appkey=youyanbin_1553944415563',
                        data: { sNo: num },
                        success: function (data) {
                            $('.del-modal').hide();
                            $('.student-list').trigger('click');
